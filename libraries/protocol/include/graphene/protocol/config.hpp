...
#define GRAPHENE_SYMBOL "KES"
#define GRAPHENE_ADDRESS_PREFIX "KES"
...
/// @{
#define GRAPHENE_DEFAULT_MAX_CONNECTION_CHAIN_LENGTH              7
#define GRAPHENE_DEFAULT_MAX_TAPS_TO_OPEN                   17
#define GRAPHENE_DEFAULT_TANK_DEPOSIT                       (GRAPHENE_BLOCKCHAIN_PRECISION * 50)
#define GRAPHENE_DEFAULT_TAP_REQUIREMENT_DEPOSIT            (GRAPHENE_BLOCKCHAIN_PRECISION * 8)
#define GRAPHENE_DEFAULT_TANK_ATTACHMENT_DEPOSIT            (GRAPHENE_BLOCKCHAIN_PRECISION * 10)
#define GRAPHENE_DEFAULT_STATEFUL_ACCESSORY_DEPOSIT_PREMIUM (GRAPHENE_BLOCKCHAIN_PRECISION * 3)
#define GRAPHENE_DEFAULT_OVERRIDE_TANK_ACCESSORY_DEPOSITS {}
   // Example: {{fc::typelist::index_of<tank_accessory_list, accessory_type>(), GRAPHENE_BLOCKCHAIN_PRECISION * 15}}
/// @}

...
namespace graphene { namespace protocol {
   ...
   /**
    * @brief The price struct stores asset prices in the acloudbank system.
    *
    ...
    * normal.
    *
    * The assets within a price are labeled base and quote. Throughout the AcloudBank code base, the convention used is
